          ...
          <StaggerChildren className="grid gap-6 md:grid-cols-2 lg:grid-cols-3" staggerDelay={90}>
            {researchAreas.map((area, i) => {
              ...
              return (
                <article
                  key={area.id}
                  className="group relative flex flex-col overflow-hidden border border-border bg-white transition-all duration-300 hover:-translate-y-1.5 hover:border-primary-green hover:shadow-xl"
                >
                  {/* Visual header — colored swatch carrying the tag */}
                  <div className={`relative flex h-40 items-center justify-center overflow-hidden ${accent}`}>
                    {tag && (
                    ...
                    <span
                      ...
                      aria-hidden="true"
                    />
                    <span className="absolute bottom-0 left-0 right-0 h-1 bg-primary-orange/80" aria-hidden="true" />
                  </div>
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <p className="mt-3 flex-1 text-sm leading-relaxed text-muted line-clamp-5">
                      {area.description}
                    </p>
                    <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-primary-green-dark opacity-0 transition-all duration-300 group-hover:translate-x-1 group-hover:opacity-100">
                      Explore group
                      <span aria-hidden="true">→</span>
                    </span>
                  </div>
